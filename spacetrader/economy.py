...
class Ware:
    ...
    params: special_resource - When this resource is available, this trade item is cheap
    params: special_resource_no - When this resource is available, this trade item is expensive
